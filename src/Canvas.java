...
public class Canvas extends JPanel
{
	...
	public Canvas ()
	{
		...
		Face face4 = new Face(new Vector[]{new Vector(100,-100,-200),new Vector(100,100,-200),new Vector(-0,100,-150),new Vector(-0,-100,-150)});
		face4.setColor(Color.gray);
		face4.generateDots(dotarea,0);
		Face face5 = new Face(new Vector[]{new Vector(-100,100,-200),new Vector(-100,-100,-200),new Vector(0,-100,-150),new Vector(0,100,-150)});
		face5.setColor(Color.gray);
		...
		Face face6 = new Face(new Vector[]{new Vector(-0,100,-250),new Vector(0,-100,-250),new Vector(-100,-100,-200),new Vector(-100,100,-200)});
		face6.setColor(Color.white);
		face6.generateDots(dotarea,0);
		Face face7 = new Face(new Vector[]{new Vector(100,100,-200),new Vector(100,-100,-200),new Vector(0,-100,-250),new Vector(0,100,-250)});
		face7.setColor(Color.white);
		face7.generateDots(dotarea,0);
		Face face8 = new Face(new Vector[]{new Vector(100,-100,-200),new Vector(0,-100,-150),new Vector(-100,-100,-200), new Vector(0,-100,-250)});
		face8.setColor(Color.white);
		face8.generateDots(dotarea,0);
		Face face9 = new Face(new Vector[]{new Vector(0,100,-250),new Vector(-100,100,-200),new Vector(0,100,-150),new Vector(100,100,-200)});
		...
		Face[] faces = new Face[]{face,face2, face3, face4, face5, face6, face7, face8, face9, face10, areaLight};
